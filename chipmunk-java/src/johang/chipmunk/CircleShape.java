...
public class CircleShape extends Shape {
	public CircleShape(Body body, float radius, float offsetX, float offsetY) {
		super(body);
		cpShapePtr = create(body, radius, offsetX, offsetY);
	}

	private native long create(Body body, float radius, float offsetX,
			float offsetY);
